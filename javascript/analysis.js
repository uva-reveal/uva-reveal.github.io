...
$('#results').html('');
  ...
  //find search results
  function find_berlin_search_results(json_file) {
    d3.json(json_file, function(data) {
      console.log(data['response']['docs'][0]['title_display']);

      // define search terms
      var needleArray1 = ['berlin']; ['cold war']; ['berlin wall']; ['germany']; ['german']; ['reagan']; ['gorbachev']; ['iron curtain']; ['honecker'];
  ...
  $('#results').html('');
    for (var i = 0; i < list_of_json.length; i++){
      find_berlin_search_results(list_of_json[i]); }
    var checkBox = document.getElementById ("cabell");
      if (checkBox.checked == true){
         results.style.display = "block"; }
      else {
        ...
        //find search results
        function find_language_search_results(json_file) {
          d3.json(json_file, function(data) {
            console.log(data['response']['docs'][0]['title_display']);

            // define search terms
            var needleArray1 = ['language words'];
        ...
        $('#results').html('');
          for (var i = 0; i < list_of_json.length; i++){
            find_language_search_results(list_of_json[i]); }
          var checkBox = document.getElementById ("cabell");
            if (checkBox.checked == true){
               results.style.display = "block"; }
            else {
              ...
              //find search results
              function find_cemetery_search_results(json_file) {
                d3.json(json_file, function(data) {
                  console.log(data['response']['docs'][0]['title_display']);

                  // define search terms
                  var needleArray1 = ['cemetery words'];
              ...
              $('#results').html('');
                for (var i = 0; i < list_of_json.length; i++){
                  find_cemetery_search_results(list_of_json[i]); }
                var checkBox = document.getElementById ("cabell");
                  if (checkBox.checked == true){
                     results.style.display = "block"; }
                  else {
